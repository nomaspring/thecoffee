	    ...
	    <article>
			...
			<form action="employee.php" method="POST">
				<div id="contents">
					...
					<?php 
						...
						foreach($worker AS $workername) {
							...
							echo '<input type="text" class="no" value="'.$i.'"><input type="text" class="name" name="'.$i.'name" value="'.$scratio[0].'"><input type="text" class="join" name="'.$i.'join" value="'.$scratio[2].'"><input type="text" class="scrate" name="'.$i.'scrate" value="'.$scratio[1].'"><input type="text" class="resign" name="'.$i.'resign" value="'.$scratio[3].'">';
							echo '</div>';
							$i++;
						}
					?>
				...
				<div class="btnbox">
					...
					<button type="button" class="btncancel" onclick="location.href='indexForPreference.php'">back</button>
				</div>
			</form>
